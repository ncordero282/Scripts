...
# This tells OSDCloud to create C:\Windows\Setup\Scripts\SetupComplete
# and wire in Start-WindowsUpdate, so first boot runs Windows Update
$Global:OSDCloud.WindowsUpdate = $true
# Optional: also have Windows try to pull driver updates
